...
public class ElectricityBillStrategy implements DebtQueryStrategy {
    @Override
    public String getDebtResult(Long citizenNo) throws JsonProcessingException {
        ...
        return DebtUtils.getObjMapInstance().writeValueAsString(new WebServiceResponse(billAmount, DebtType.ELEKTIRIK_FATURASI.getVal()));
    }
}
